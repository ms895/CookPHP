...
//MYSQLI_CLIENT_SSL 	使用 SSL 加密
    ...
    public function connect() {
        ...
        mysqli_real_connect($this->connection, $this->config['host'], $this->config['username'], $this->config['password'], $this->config['database'], $this->config['port'], $this->config['socket'], $this->config['flags']);
