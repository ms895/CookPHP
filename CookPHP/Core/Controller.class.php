...
abstract class Controller extends View {
     ...
     * @return \Core\Model
     */
    protected static function model($table = null, $config = []) {
     ...
     * @return string
     */
    protected static function url(string $url, $params = [], $domain = false) {
     ...
     * @param string $url
     */
    protected static function header($url) {
        Loader::header($url);
    }
     ...
     * @return string
     */
    protected static function headerUrl(string $url, $params = [], $domain = false) {
