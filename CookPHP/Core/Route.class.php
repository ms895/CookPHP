...
class Route {
    ...
    private static function initLanguage(&$urls) {
        ...
        defined('LANGUAGE') or define('LANGUAGE', strtolower(Config::get('default.langarray') && in_array($lang, Config::get('default.langarray')) ? $lang : Config::get('default.language')));
