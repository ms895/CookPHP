...
class Language {
    ...
    public static function get($key, $default = null) {
        ...
        return empty($name) ? (self::$data[$file] ?? null) : (self::$data[$file][$name] ?? $default);
    }
    ...
    public static function load($filename) {
        if (file_exists($file = __LANGUAGE__ . (APP_ROUTE ? strtolower(LANGUAGE) . DS . APP_ROUTE : strtolower(LANGUAGE)) . DS . ucfirst(strtolower($filename)) . '.php')) {
